...
public class RoomController {
    ...
    public CommonResult<RealRoomVO> queryRoomList(
    ...
    public CommonResult<RealRoomVO> queryRelatedRoomList(
    ...
    public CommonResult<Void> createRoom(
    ...
    public CommonResult<Void> applyToJoinRoom(
    ...
    public CommonResult<Void> agreeApply(
    ...
    public CommonResult<Void> refuseApply(
